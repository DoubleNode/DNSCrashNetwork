![DoubleNode Swift Framework](https://github.com/DoubleNode/DNSCrashNetwork/raw/master/DNSFrameworkLogo.png)
...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSCrashNetwork.git", from: "1.9.2")
]
```
...
-   Alamofire v5.6.1+
-   DNSBlankNetwork v1.9.5+
-   DNSCore v1.8.1+
-   DNSDataObjects v1.8.22+
-   DNSError v1.8.0+
-   DNSProtocols v1.9.7+
